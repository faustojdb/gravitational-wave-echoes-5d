...
\begin{titlepage}
    ...
    \textbf{5 con errores $<$ 0.1\%}\\[0.3cm]
    \begin{tabular}{lc}
    $m_p/m_e = 6\pi^5$ & 0.002\% error \\
    $c = (3 - 1/(7\pi)^2) \times 10^8$ & 0.0003\% error \\
    $1/\alpha = 7^2\pi - 7 - \pi^2$ & 0.024\% error \\
    \end{tabular}
    \end{tcolorbox}
...
\include{capitulos/capitulo_06}
\include{capitulos/capitulo_07}
\include{capitulos/capitulo_08}
\include{capitulos/capitulo_09}
